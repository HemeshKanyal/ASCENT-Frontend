...
export default function HomeScreen() {
  return (
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
      ...
      <Pressable
        onPress={async () => {
          const { clearUserProfile } = require("../../src/services/userProfile");
          await clearUserProfile();
          router.replace("/onboarding" as any);
        }}
        style={{ marginTop: 40, padding: 10, backgroundColor: '#ffebee' }}
      >
        <Text style={{ color: 'red' }}>Reset Profile (Dev Only)</Text>
      </Pressable>
